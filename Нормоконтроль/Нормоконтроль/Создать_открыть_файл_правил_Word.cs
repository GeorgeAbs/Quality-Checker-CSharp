...
{
    public partial class Создать_открыть_файл_правил_Word : Form
    {
        public Создать_открыть_файл_правил_Word()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                Form q = new Настройка_правил_Word();
                q.Visible = true;
                q.TopLevel = true;
                this.Close();
            }
        ...
        {
            saveFileDialog1.Filter = "Файл с правилами|*.W_rules";
